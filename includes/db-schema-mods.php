...
function custom_lottery_apply_schema_mods() {
    ...
    // Add final_amount and admin_notes to lotto_payout_requests table.
    // dbDelta is idempotent, so we can define the full schema and it will add/modify columns as needed.
